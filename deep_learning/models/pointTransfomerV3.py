...
class Block(PointModule):
    def __init__(
        ...
        #     ).to('cuda:1'), 
        #     nn.Linear(channels, channels).to('cuda:1'),
        #     norm_layer(channels),
        # )
...
class PointTransformerV3(PointModule):
    def __init__(
        ...
        if not self.cls_mode:
            ...
            # ADDED BY URWIK
            finalMLP = PointSequential()
            finalMLP.add(
                MLP(
                    in_channels=dec_channels[0],
                    hidden_channels=int(dec_channels[0] * mlp_ratio),
                    out_channels=1,
                    drop=0.0,
                ),
                name="finalMLP",
            ...
            self.dec.add(module=finalMLP, name="finalMLP")
