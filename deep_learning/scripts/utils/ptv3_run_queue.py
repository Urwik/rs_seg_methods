...
if __name__ == '__main__':
    ...
    EXP_QUEUE_FILE = '/home/arvc/Fran/workSpaces/nn_ws/binary_segmentation/tests/PointTransformerV3/exp_queue.csv'
    ...
    while exp_queue.get_num_rows_in_csv() > 0:
        ...
        config_node['train']['grid_size'] = voxel_size
        config_node['train']['loader']['num_workers'] = 10
        config_node['train']['device'] = 'cuda:1'
        config_node['train']['loader']['batch_size'] = 4
